...
export const NewsCard = ({
  ...
  const props = { date, direction, header, image, link, moveleft, text };
  ...
  if (width < 540) text = Shorten(text, 100);
  else if (width < 1000) text = Shorten(text, 150);
