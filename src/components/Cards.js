    ...
    if (type === 'primary') {
        return (
            <div className="contener">
                <div>
                    <Padding size={[16, 16]}> <Image src={image} width='263.33' height='160' borderRadius='10' /></Padding>
                    <Padding size={[15, 16]}>
        ...
        return (
            <div className="contener">
                ...
                <div style={{width:'263px'}}>
                    <div className="scratches"></div>
                    <Padding size={[28,16,13, 0]}><Image className="rounded" src={image}></Image></Padding>
